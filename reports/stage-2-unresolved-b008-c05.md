...
| CR000210 | FEniCS is an aggregate FEniCS/FEniCSx finite-element software platform. Stage 1 contains PRL000268 for Atlas paper 752 and PRL000321 for Atlas paper 836. Paper 752 compares PINN results with FEniCS finite-element solutions; paper 836 explicitly states that FEniCSx solved the Navier-Cauchy equations. | Preserve both verified paper-software mentions and do not infer one aggregate SPDX license across the component projects. Component-level license/dependency normalization remains Stage 3 work. |
