...
| Last completed scale-out checkpoint | Stage3-S002 |
| Next scale-out checkpoint | Stage3-S003 |
| Last completed resource | CR000004 |
| Next resource | CR000005 |
| Next planned checkpoint resources | CR000005 |
| Current scale-out batch | SOB001 |
| Completed Stage-3 resource count | 13 |
| Remaining Stage-3 registry resource count | 351 |
| Approved pilot resources completed | 10 / 10 |
| Completed experiment count | 27 |
| Completed configuration count | 87 |
| Technical evidence records | 156 |
| Static reproducibility assessments | 13 |
| Current QA status | PASS |
| Current unresolved technical item count | 30 |
| Next unresolved ID | S3U-0031 |
| Current conflicting-evidence finding count | 6 |
...
Start **`Stage3-S003`** with **`CR000005`**. `CR000004` required an adaptive single-resource checkpoint, so the deterministic sequence continues with the unprocessed second member of the original pair.
