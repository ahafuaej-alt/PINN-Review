...
| Last completed scale-out checkpoint | Stage3-S026 |
| Next scale-out checkpoint | Stage3-S027 |
| Last completed resource | CR000033 |
| Next resource | CR000034 |
| Next planned checkpoint resources | CR000034 |
| Current scale-out batch | SOB003 |
| Completed Stage-3 resource count | 40 |
| Remaining Stage-3 registry resource count | 324 |
| Approved pilot resources completed | 10 / 10 |
| Completed experiment count | 73 |
| Completed configuration count | 177 |
| Technical evidence records | 487 |
| Static reproducibility assessments | 40 |
| Current QA status | PASS |
| Current unresolved technical item count | 169 |
| Next unresolved ID | S3U-0170 |
| Current conflicting-evidence finding count | 47 |
...
The batch remains open; the exact next resource is `CR000034`.
...
Start **`Stage3-S027`** with **`CR000034`**.
